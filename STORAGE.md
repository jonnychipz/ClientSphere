...
The Container App managed identity has Table Data Contributor and Blob Data Reader. The GitHub deployment identity has Blob Data Contributor so it can publish refreshed agent metadata. Shared-key access and public blob access are disabled.
